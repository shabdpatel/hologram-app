...
for _ in range(5):
    ...
    obj_file = "/mnt/sdb4/CSIR Intern/Results/CSIO_oa_1024x1024.bmp"  # Path to the object file
...
plt.imsave(f'{current_time}_numeri_Re{mse_min}.bmp', abs(cad_f[inde_]), cmap='gray')  # Save corresponding CAD result
